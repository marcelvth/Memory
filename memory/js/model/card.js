class Card extends Observable {
    ...
    deck() {
        ...
        switch (this.cardId) {
            ...
            case 4: this.cardId = "url(img/groep_4/girls/memorycardgirlsrapunzel.png)"; break;
            case 5: this.cardId = "url(img/groep_4/girls/memorycardgirlssnowwhite.png)"; break;
            case 6: this.cardId = "url(img/groep_4/girls/memorycardgirlsyasmin.png)"; break;
            ...
            case 9: this.cardId = "url(img/groep_4/boys/memorycardboysally.png)"; break;
